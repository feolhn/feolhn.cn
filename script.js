    ...
    projects: [
      ...
      },
      {
        ...
        resources: [
          ...
          { date: "2026-06-30 21:09", participants: ["DC", "K", "Alex（胡嘉伟）"], summary: "会议进一步提出 X 信息聚合框架：先用用户关系网组织 thread，再用 AI 语义标签聚合成 event，并通过关键词、小模型和 AI 打分过滤噪声。", delta: "从产品定位推进到可落地的关系网、语义层与成本控制方案", url: "https://cloud.huozi.app/p/6be9sh9qjz" },
          { date: "2026-06-30 21:23", participants: ["DC", "K", "Alex（胡嘉伟）"], summary: "会议转向产品的商业化与市场路径，讨论 AI 总结服务如何建立用户习惯、沉淀为付费知识资产，并规划 TMTB 亚洲版及 Wiki 式延伸产品。", delta: "新增竞品分析、用户迁移、付费知识资产与投资人沟通议题", url: "https://cloud.huozi.app/p/x3a3tt97jj" },
          { date: "2026-06-30 21:47", participants: ["DC", "K", "Alex（胡嘉伟）"], summary: "会议把信息聚合推进到 Feed 产品设计：设定时间窗口和评分体系，结合上下文加载、标签过滤、缓存与人工 Review，评估信息和用户的真实价值。", delta: "新增自动化 Feed 流程、上下文策略、缓存机制与用户价值评估", url: "https://cloud.huozi.app/p/mff73vpy5y" },
          { date: "2026-06-30 22:31", participants: ["DC", "K", "Alex（胡嘉伟）"], summary: "会议将讨论扩展到 AI 工具的价值模式与数据基础设施：通过封装 API 和搜索降低使用门槛，同时持续生产 TMTB 亚洲版内容，并研究无头浏览器取数。", delta: "新增工具产品付费模式、内容生产计划与外部数据获取方案", url: "https://cloud.huozi.app/p/nsnnzdknwv" },
